...
## 五之二、同类句子级基线对比(multifieldqa_zh 前 20 条,近似实现)

| 预算 B | Selective Context 压缩/保真 | RECOMP 风格 压缩/保真 | FF-Compactor 压缩/保真 |
|--------|---------------------------|---------------------|----------------------|
| 30% | 0.695 / 0.887 | 0.691 / 0.927 | 0.853 / **0.980** |
| 50% | 0.459 / 0.917 | 0.423 / 0.966 | 0.753 / **0.993** |
| 70% | 0.267 / 0.943 | 0.254 / 0.979 | 0.710 / **0.993** |

**结论**:同预算下 FF-Compactor 保真度全面领先(0.980-0.993 vs 0.887-0.979),
且压缩率更高(贪心选句 + 保真门控优于纯打分/抽取)。
注:Selective Context 原文用 LLM 打分、RECOMP 用监督摘要器,此处为本地近似实现。
