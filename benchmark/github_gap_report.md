...
Headroom 在 JSON 上的压缩率随规模稳定在 ~0.345,但保真度仅 ~0.397;FF-Compactor 压缩率 0.500 更高且保真度 0.521 领先 0.124。且代码压缩器经 assistant/tool 双 role 验证均被 `protected:recent_code` 保护,无法触发。
